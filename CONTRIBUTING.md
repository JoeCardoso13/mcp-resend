...
1. **Add response models** to `src/mcp_resend/api_models.py`
2. **Add client methods** to `src/mcp_resend/api_client.py`
3. **Add the tool** to `src/mcp_resend/server.py` using `@mcp.tool()`
